...
корпоративного ПО это обычное дело), то можно заметить, что чем дольше продукт существует, тем более важным из его
свойств становится **способность к постоянному развитию**.  
...
терминами и понятиями (хотя в некоторой степени и это присутствует), а потому, что некоторые из этих терминов в
контексте *Чистой Архитектуры* приобретают дополнительный, а иногда и особенный смысл.  
...
- *Entities* - "бизнес-правила, независимые от приложения" (*Entities* не всегда нужно понимать буквально, как
"Сущности", лучше на них смотреть в контексте возможности *повторного использования* приложениями - об этом ниже)
...
- *Инфраструктура* - всё, что находится за пределами слоя *Domain*, и то, что по отношению к нему является вторичным. 
...
Следующий выпуск планируется посвятить подробному рассказу о *Dependency Inversion* - шаблоне проектирования, который,
как уже было сказано, фактически является главным из тех, что используются в *Чистой Архитектуре*.
