...
проектирования ***Dependency Inversion***, который фактически является главным шаблоном проектирования (если брать ООП),
поскольку *правило зависимостей* реализуется именно с его помощью.
...
Следующий выпуск планируется посвятить рассказу о Главном Паттерне Чистой Архитектуры.
